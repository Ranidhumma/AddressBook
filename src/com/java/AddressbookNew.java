...
public class AddressbookNew {
	...
	static List<ContactInfo> addressBook;

	public static void main(String[] args) {
		addressBook = new LinkedList<ContactInfo>();
	...
	private static void deleteContact(Scanner scanner) {
		...
		ContactInfo deleteContact = null;
	...
	private static void editContactDetails(ContactInfo editContact, Scanner scanner) {
	...
	private static void showContacts() {
		if (addressBook.isEmpty()) {
			...
			for (ContactInfo contact : addressBook) {
	...
	public static String validateFirstName(String firstName, Scanner scanner) {
		...
		while (!inputMatcher.matches()) {
			...
			System.out.println("length must not exceeds 10 (Exa: Rani)");
